...
Config.ATM = {
    ...
    {id = 277, x = -1094.161, y = -2826.075, z = 27.708},
    {id = 277, x = -1095.774, y = -2825.155, z = 27.708},
    {id = 277, x = 5.134, y = -919.949, z = 29.557},
    {id = 277, x = -457.70, y = -325.83, z = 33.62},
    {id = 277, x = -42.68, y = -1108.01, z = 26.43},
    {id = 277, x = 930.46, y = -987.45, z = 37.52}
}
